//File: Assignment 2 Version A
//Author: Minsu Kim 30068971
//Date: Oct.1, 2022
//Description: This assignment will take binary 0x07FC07FC and go through an algorithm that will reverse it and print both the original and the reversed.
...
main:
	...
	mov x_r, 0x07FC07FC									//Setting x variable as 0x07FC07FC
